...
$sqlExamenes = "SELECT 
    ...
    COALESCE((select er.porcentaje from respuestas_estudiantes er where er.id_estudiante = ea.id_estudiante and er.id_examen = ea.id_examen ),'')porcentaje,
    COALESCE((select er.fecha_realizacion  from respuestas_estudiantes er where er.id_estudiante = ea.id_estudiante and er.id_examen = ea.id_examen ),'')fecha_realizacion    
