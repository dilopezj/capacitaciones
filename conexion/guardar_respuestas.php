...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($cantidad_respuestas_total == 0){
     ...
     // Insertar datos en la tabla respuestas_estudiantes
        $sql_insert = "INSERT INTO `respuestas_estudiantes`(`id_estudiante`, `id_examen`, `respuestas_correctas`, `respuestas_incorrectas`, `total_preguntas`, `porcentaje`, `fecha_realizacion`) 
                                                   VALUES ($id_estudiante,$examenId,$cantidad_respuestas_buenas,$cantidad_respuestas_malas,$cantidad_respuestas_total,$porcentaje_correctas,CURRENT_TIMESTAMP)";
