...
if (isset($_POST['idEstudiante'])) {
    ...
    $sqlSelect = "Select e.id_examen from examenes e where e.id_modulo = $idCurso and tipo_examen in ('PREVIA', 'INTERMEDIA')";
        ...
        if ($resultEx->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if (!empty($setValues)) {
                    ...
                    $contSinData++;
                    // Si no se enviaron variables, no se realiza ninguna actualización                   
                }               
            }
