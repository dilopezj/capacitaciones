                ...
                if ($resultadoExamenes->num_rows > 0) {
                    ...
                    while ($filaExamenes = $resultadoExamenes->fetch_assoc()) {
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <form action="">
                                    <?php if ($filaExamenes["tipo_examen"] == 'FINAL' && $filaExamenes["fecha_realizacion_final"] == '') { ?>
                                        <button type="button" class="btn btn-raised btn-sm btn-sura"
                                            onclick="realizarExamen_evaluador('<?php echo $filaExamenes["id_estudiante"] ?>', '<?php echo $filaExamenes["id_modulo"] ?>')">Realizar</button>
                                    <?php } ?>
